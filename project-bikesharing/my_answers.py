...
class NeuralNetwork(object):
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        hidden_error = np.matmul(output_error_term, self.weights_hidden_to_output)
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += (delta_weights_h_o * learning_rate) / n_records # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += (delta_weights_i_h / learning_rate) / n_records # update input-to-hidden weights with gradient descent step
